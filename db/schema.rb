...
ActiveRecord::Schema[7.1].define(version: 20_240_424_014_841) do
  ...
  create_table 'job_seeker_availabilities', force: :cascade do |t|
    ...
    t.index %w[date_start date_end], name: 'index_job_seeker_availabilities_on_date_start_and_date_end'
    t.index %w[job_seeker_id date_start date_end], name: 'idx_on_job_seeker_id_date_start_date_end_6cd5654746',
                                                   unique: true
